...
namespace AdSoftwareSystems.Tracking.Mobile.Store.Data
{
    /// <summary>
    ...
    public abstract class SampleDataCommon : AdSoftwareSystems.Tracking.Mobile.Store.Common.BindableBase
    {
